...
const TechStack = () => {
  ...
  useEffect(() => {
    // Debounced scroll handler using rAF to prevent excessive re-renders
    let ticking = false;
    const handleScroll = () => {
      if (!ticking) {
  ...
  // Load textures inside the component, not at module scope
  ...
  // Pre-assign materials once to avoid random reassignment on every render
